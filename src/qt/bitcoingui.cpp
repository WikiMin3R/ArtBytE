...
{
    resize(850+95, 550);
    setWindowTitle(tr("ArtBytE") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to an Artbyte address"));
    ...
    aboutAction = new QAction(tr("&About Artbyte"), this);
    aboutAction->setToolTip(tr("Show information about Artbyte"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Artbyte"));
...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet(fUseBlackTheme ? "QWidget { background: rgb(190,0,0); }" : "QWidget { background: none; }"); //this determines the color of the entire left toolbar
    return spacer;
}
...
void BitcoinGUI::createToolBars()
{
    ...
    if (fUseBlackTheme)
    {
        ...
        header->setStyleSheet("QWidget { background-color: rgb(190,0,0); background-repeat: no-repeat; background-image: url(:/images/header); background-position: top center; }"); //this line determines the "wrapper" color around the image header
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Artbyte client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Artbyte client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ArtBytE network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Artbyte address or malformed URI parameters."));
    }
